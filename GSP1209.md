...
[GSP1209_intro_genai_sdk.ipynb](https://github.com/acvetochka/googleLabs/blob/main/GSP1209_intro_genai_sdk.ipynb)
...
3. If necessary, copy the Username below and paste it into the Sign in dialog.
  ```
  student-02-8a006e1e6d00@qwiklabs.net
  ```
...
For more examples of Function Calling, refer to this lab.
